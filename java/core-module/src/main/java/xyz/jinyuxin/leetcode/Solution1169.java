...
public class Solution1169 {
  ...
  public static void main(String[] args) {
    ...
    String[] transactions3 = {
            ...
            "bob,710,1726,barcelona","bob,720,596,bangkok",
    ...
    String[] transactions5 = {
            "bob,627,1973,amsterdam","alex,387,885,bangkok",
            "alex,355,1029,barcelona","alex,587,402,bangkok",
            "chalicefy,973,830,barcelona","alex,932,86,bangkok",
